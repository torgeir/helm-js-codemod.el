...
(use-package helm-js-codemod
  :commands (helm-js-codemod)
  :init
  (setq helm-js-codemod-mod-dir (expand-file-name "~/.emacs.d/path/to/codemods/")))
```

## Features

Run `helm-js-codemod` to run one your favorite js codemods on the current sentence or selected region, e.g. to [turn this bound functions into arrow functions](https://github.com/mikaelbr/vscodemod/blob/140f401415194772bbd42eaa37ac26f62909914e/codemods/to-arrow.js), like so
...
Copyright (C) 2019 Torgeir Thoresen
